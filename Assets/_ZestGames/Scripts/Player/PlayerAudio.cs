...
namespace ZestGames
{
    public class PlayerAudio : MonoBehaviour
    {
        ...
        {
            AudioHandler.PlayAudio(Enums.AudioType.SpendMoney, 0.5f, _currentSpendPitch);
        ...
        {
            AudioHandler.PlayAudio(Enums.AudioType.CollectMoney, 0.5f, _currentCollectPitch);
