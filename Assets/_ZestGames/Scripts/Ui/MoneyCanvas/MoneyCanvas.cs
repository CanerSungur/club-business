...
namespace ZestGames
{
    public class MoneyCanvas : MonoBehaviour
    {
        ...
        {
            CollectMoney2D money = ObjectPooler.Instance.SpawnFromPool(Enums.PoolStamp.MoneyCollect2D, Vector3.zero, Quaternion.identity, transform).GetComponent<CollectMoney2D>();
        ...
        {
            SpendMoney2D money = ObjectPooler.Instance.SpawnFromPool(Enums.PoolStamp.MoneySpend2D, Vector3.zero, Quaternion.identity, transform).GetComponent<SpendMoney2D>();
